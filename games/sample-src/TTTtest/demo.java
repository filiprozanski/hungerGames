...
public class demo extends JFrame implements ActionListener {
	...
	public demo() {
		...
		/*
		 * JTextArea edtDebug = new JTextArea(); edtDebug.setFont(new
		 * Font("Tahoma", Font.BOLD, 12)); edtDebug.setForeground(new Color(0,
		 * 255, 0)); edtDebug.setBackground(new Color(0, 0, 0));
		 * edtDebug.setBounds(10, 0, 252, 135); contentPane.add(edtDebug);
		 * 
		 * JScrollPane scrollBar = new JScrollPane(edtDebug);
		 * scrollBar.setBounds(226, 91, 270, 77); scrollBar
