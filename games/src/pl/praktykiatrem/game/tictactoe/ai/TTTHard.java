...
public class TTTHard implements TTTDifficulty {
	...
	public TTTHard(Rules rules, PlayerStatus me) {
		computer = me;
		this.rules = rules;
	...
	private int[] computeMove(Board board, int depth, PlayerStatus currentPlayer) {
