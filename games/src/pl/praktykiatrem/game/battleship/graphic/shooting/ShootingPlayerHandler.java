...
public class ShootingPlayerHandler {
	...
	public ShootingPlayerHandler(PlayerStatus player, boolean status,
	...
	public boolean makeMove(PlayerStatus opponent, int x, int y) {
	...
	public void drawLeftShips(PlayerStatus opponent) {
