...
public class PlayerStatus extends
	 ...
	 *            wspó³rzêdna pionowa
	 */
	public void takeOutShip(Coordinates coords) {
		board.takeOut(coords);
	}
	 ...
	 * @param y
	 */
	public int reducePolesNumber(Coordinates coords) {
		Place p = board.getPlace(coords);
